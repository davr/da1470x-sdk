...
Commands overview
-----------------
ST FW application supports the following commands:
- BLE

| OP code | Name                      | Chip support                      | Handled by    | Description                                                                                        |
| ------- | ------------------------- | --------------------------------- | ------------- | -------------------------------------------------------------------------------------------------- |
| 0x201E  | cont_pkt_tx               | DA1468x <br> DA1469x <br> DA1470x | BLE stack     | Start test - generates BLE test reference packets at a fixed interval                              |
| 0x2034  | TX_TEST_ENH               | DA1469x                           | BLE stack     | Starts continuous Tx at 1 or 2Mbps                                                                 |
| 0x201D  | start_pkt_rx              | DA1468x <br> DA1469x <br> DA1470x | BLE stack     | Start test - receive BLE test reference packets at a fixed interval                                |
| 0x2033  | RX_TEST_ENH               | DA1469x                           | BLE stack     | Starts continuous Rx at 1 or 2Mbps                                                                 |
| 0x201F  | stoptest                  | DA1468x <br> DA1469x <br> DA1470x | BLE stack     | Stop any BLE test which is in progress                                                             |
| 0x204B  | le_rx_tx_pwr              | DA1469x                           | BLE stack     | Read min and max transmit power                                                                    |
| 0x2050  | le_tx_test_v3             | DA1469x                           | BLE stack     | Start test by generating test reference packets at a fixed interval                                |
| 0x207B  | le_tx_test_v4             | DA1469x                           | BLE stack     | Start test by generating test reference packets at a fixed interval including transmit power level |
| 0x0C03  | reset                     | DA1468x <br> DA1469x <br> DA1470x | BLE stack     | Reset BLE Link Layer                                                                               |
...
| 0xFC16  | DBG_RX_TEST_STATS_GET     | DA1469x <br> DA1470x              | BLE stack     | Gets the extra Rx test results                                                                     |
| 0xFC17  | DBG_START_CALIBRATION     | DA1469x <br> DA1470x              | BLE stack     | Starts calibration                                                                                 |
| 0xFC18  | DBG_GET_CAL_RESULT        | DA1469x <br> DA1470x              | BLE stack     | Gets the result of the calibration via a Command Complete event                                    |
| 0xFC14  | DBG_TX_TEST_ENH           | DA1469x <br> DA1470x              | BLE stack     | Starts continuous Tx at 1 or 2Mbps and sends a burst of N packets                                  |
| 0xFC15  | DBG_RX_TEST_ENH           | DA1469x <br> DA1470x              | BLE stack     | Starts continuous Rx at 1 or 2 Mbps (enhanced)                                                     |
| 0xFC3B  | DBG_SET_TX_PW             | DA1469x <br> DA1470x              | BLE stack     | Sets the Tx power                                                                                  |
| 0xFC13  | DBG_TEST_SET_TX_PW        | DA1469x <br> DA1470x              | BLE stack     | Sets the Tx power in Test mode                                                                     |
| 0xFC19  | DBG_SET_EVT_RPRT_STAT     | DA1469x <br> DA1470x              | BLE stack     | Enables / Disables the reporting after each test 'event'                                           |
...
| OP code | Name              | Chip support                      | Handled by | Description                                  |
| ------- | ----------------- | --------------------------------- | ---------- | -------------------------------------------- |
| 0xFE01  | hci_cmd_sleep     | DA1468x <br> DA1469x <br> DA1470x | ST app     | Set platform sleep mode                      |
| 0xFE02  | xtal_trim         | DA1468x <br> DA1469x <br> DA1470x | ST app     | Manage XTAL calibration                      |
| 0xFE04  | hci_cmd_otp_read  | DA1468x <br> DA1469x <br> DA1470x | ST app     | Read from OTP memory                         |
| 0xFE05  | hci_cmd_otp_write | DA1468x <br> DA1469x <br> DA1470x | ST app     | Write to OTP memory                          |
| 0xFE06  | hci_cmd_rw_reg    | DA1468x <br> DA1469x <br> DA1470x | ST app     | Read/write register                          |
| 0xFE08  | fw_version_get    | DA1468x <br> DA1469x <br> DA1470x | ST app     | Get ST FW version                            |
...
> Note: XTAL trim value calibration returns zero on success. A non zero value indicates failure.<br>
